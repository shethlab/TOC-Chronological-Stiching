...
function [NSx1, NEV1] = combineNSxNEVStolen(filename1, filename2)
...
% Opening NEV files
fileNameNEV1 = [NSx1.MetaTags.FilePath '/' NSx1.MetaTags.Filename, '.nev'];
fileNameNEV2 = [NSx2.MetaTags.FilePath '/' NSx2.MetaTags.Filename, '.nev'];
clear NSx2;

if (exist(fileNameNEV1, 'file') == 2) && (exist(fileNameNEV2, 'file') ==2)
    disp('Openning corresponding NEV files...');
    NEV1 = openNEV('read', fileNameNEV1, 'nosave');
    NEV2 = openNEV('read', fileNameNEV2, 'nosave');
else
...
NEV1.Data.Comments.TimeStampStarted = [NEV1.Data.Comments.TimeStampStarted, NEV2.Data.Comments.TimeStampStarted];
NEV1.Data.Comments.TimeStampStartedSec = [NEV1.Data.Comments.TimeStampStartedSec, NEV2.Data.Comments.TimeStampStartedSec];
